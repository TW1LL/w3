...
urlpatterns = [
        ...
        url(r'^password/change$', views.password_change, {'template_name': 'account/password_change.html',
                                                          'extra_context':view_vars()},
            name='password_change'),
        url(r'^password/change/done$', views.password_change_done,
            {'template_name': 'account/password_change_done.html', 'extra_context':view_vars()},
            name='password_change_done'),

        url(r'^register$', Account.register, name='registration'),

        url(r'^password/reset$', views.password_reset,
            {'template_name': 'account/password_reset.html', 'extra_context':view_vars()},
            name='password_reset'),
        url(r'^password/reset/done$', views.password_reset_done,
            {'template_name': 'account/password_reset_done.html', 'extra_context':view_vars()},
